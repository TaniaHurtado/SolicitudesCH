...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post observations_url, params: { observation: { Solicitud_id: @observation.Solicitud_id, descripcion: @observation.descripcion, motivo: @observation.motivo } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { Solicitud_id: @observation.Solicitud_id, descripcion: @observation.descripcion, motivo: @observation.motivo } }
