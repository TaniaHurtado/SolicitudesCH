...
class EvaluacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluacions_url, params: { evaluacion: { calificacion: @evaluacion.calificacion, obervacion: @evaluacion.obervacion, solicitud_id: @evaluacion.solicitud_id } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { calificacion: @evaluacion.calificacion, obervacion: @evaluacion.obervacion, solicitud_id: @evaluacion.solicitud_id } }
